...
from Physics.QuantumComputation.Encoder.Group.MajoranaGroup import MajoranaGroup
...
class MajoranaCode:
    ...
    def push(self, checker, *args):
        ...
        if self.number_checker == 0:
            ...
            self.generator_vector = np.empty(self.number_fermion, dtype=MajoranaGroup)
