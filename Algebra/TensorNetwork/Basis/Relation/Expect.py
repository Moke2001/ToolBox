    ...
    if isinstance(operator,Operator):
        ...
        if isinstance(operator.target_index,int):
            ...
            if index_op>index_c:
                ...
                ##  作用在右端，中心在左端
                if index_op==mps_list.number_fermion-1 and index_c==0:
                ...
                ##  作用在右端，中心不在左端
                elif index_op==mps_list.number_fermion-1 and index_c!=0:
                    list_end = np.einsum('ab,bd,ed->ae', mps_list[index_op], operator.data,mps_list[index_op].conjugate())
            ...
            ##  当作用在中心左边时
                ...
                ##  作用在左端，中心在右端
                if index_c==mps_list.number_fermion-1 and index_op==0:
                ...
                ##  作用不在左端，中心在右端
                elif index_c==mps_list.number_fermion-1 and index_op!=0:
            ...
            ##  作用与中心重合时
                ...
                ##  在右端
                elif  index_c==mps_list.number_fermion-1:
        ...
        ##  双位点作用情况
            ...
            if index_0 == index_n or index_1 == index_n:
                ...
                ##  在两端
                if index_1 == mps_list.number_fermion-1 and index_0==0:
                    s='bc,cd,bdfg,fh,hg->'

                ##  在左端
                elif index_1 != mps_list.number_fermion-1 and index_0==0:
            ...
            ##  两者不重合时
                ...
                if index_0>index_n:
                    ...
                    ##  作用在右端，中心在左端
                    if index_1==mps_list.number_fermion-1 and index_n==0:
                    ...
                    ##  作用不在右端，中心在左端
                    elif index_1!=mps_list.number_fermion-1 and index_n==0:
                        list_start = np.einsum('ab,ac->bc', mps_list[index_n], mps_list[index_n].conjugate())
                ...
                ##  作用在中心左端时
                    ...
                    ##  作用在左端，中心在右端
                    if index_n==mps_list.number_fermion-1 and index_0==0:
                    ...
                    ##  作用在左端，中心不在右端
                    elif index_n!=mps_list.number_fermion-1 and index_0==0:
