...
from Basis.Operator.Lindbladian.LocalDecay import local_decay
...
def compare():
    ...
    H_list_me = hamiltonian_transverse_field_ising1(3, [0.2, 0.2], [0.5, 0.5, 0.5])  # 哈密顿量张量
    C_list_me = local_decay(3, [0.2, 0.2, 0.2])  # 坍缩算符张量
    expect_operator_me = pauli_operator(3,0,'z') # 可观测量算符张量
