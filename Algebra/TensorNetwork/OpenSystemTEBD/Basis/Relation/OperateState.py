...
def operate_state(operator, mps_list_origin, chi):
    ...
    if isinstance(operator, Operator):
        ...
        if isinstance(operator.target_index, int):
            ...
            ##  右端的作用方式
            elif operator.target_index == mps_list.number_fermion - 1:
        ...
        ##  算符作用在两个位点的情况，要求两个位点相邻
            ...
            ##  左端的作用方式
            if operator.target_index[0] == 0 and operator.target_index[1] != mps_list.number_fermion - 1:
            ...
            ##  右端的作用方式
            elif operator.target_index[0] != 0 and operator.target_index[1] == mps_list.number_fermion - 1:
