    ...
    if type=="L" or type=="l":
        ...
        if isinstance(operator, Operator):
            ...
            if isinstance(operator.target_index, int):
                ...
                ##  右端的作用方式
                elif operator.target_index == rho.number_fermion - 1:
            ...
            ##  算符作用在两个位点的情况，要求两个位点相邻
                ...
                ##  左端的作用方式
                if operator.target_index[0] == 0 and operator.target_index[1] != rho.number_fermion - 1:
                ...
                ##  右端的作用方式
                elif operator.target_index[0] != 0 and operator.target_index[1] == rho.number_fermion - 1:
