...
class CouplingTermFormat(TermFormat):
    ...
    def copy(self):
        if self.time:
            return CouplingTermFormat(self.label, self.position_0, self.position_1, self.op_0, self.op_1, self.function,
                self.function_params)
        else:
            return CouplingTermFormat(self.label, self.position_0, self.position_1, self.op_0, self.op_1, self.strength)
