import numpy as np
from qutip import *
from Framework.QutipBox.SiteQutip.SiteQutip import SiteQutip
...
class LatticeQutip(LatticeFormat):
    ...
    def __init__(self,lattice_format):
        super().__init__()
        cell_period_list=lattice_format.cell_period_list.copy()
        cell_vector_list=lattice_format.cell_vector_list.copy()
        inner_site_list=lattice_format.inner_site_list.copy()
        inner_coordinate_list=lattice_format.inner_coordinate_list.copy()
