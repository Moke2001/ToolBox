...
def map_chain(pauli_code):
    ...
    print('它的逻辑比特数是：' + str(pauli_code.N - len(pauli_code.generator_vector)))
    print('')
    ...
    print('它的逻辑比特数是：' + str(majorana_code.N - len(majorana_code.generator_vector)))
    print('')
    ...
    print('它的逻辑比特数是：' + str(css_code.N - len(css_code.generator_vector)))
    print('')
    ...
    print('它的逻辑比特数是：' + str(fermionic_code.N - len(fermionic_code.generator_vector)))
    print('')
