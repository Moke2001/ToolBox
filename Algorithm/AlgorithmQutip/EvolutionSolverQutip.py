...
from State.StateQutip.StateQutip import StateQutip
...
from qutip import *
from Algorithm.Interface.InterfaceQutip.GetModelQutip import get_model_qutip
from Algorithm.Interface.InterfaceQutip.GetOperatorQutip import get_operator_qutip
...
def evolution_solver_qutip(model_format:ModelFormat, psi_origin, expectation_terms:list, t_list:np.ndarray):
    ...
    psi=state_preparer(model_format,psi_origin,'qutip')
    ...
    ##  态矢赋值
    state_result=StateQutip(psi_result,model_format.get_dimension_array())
