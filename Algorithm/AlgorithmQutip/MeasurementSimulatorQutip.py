...
"""
def measurement_simulator_qutip(model_origin, psi_origin, projector_list, eigenvalue_list)->tuple[float,State]:
    ##  标准化
    ...
    psi_final.apply(projector_list[index],model,True,'vector')
